...
class post_list_view: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBAction func publish_click(_ sender: Any) {
        ...
        AF.request("https://" + global_value.server_url + "/control/"+public_func.version+"/git_page_publish", method: .post, parameters: para, encoding: JSONEncoding.default).validate().responseJSON { response in
